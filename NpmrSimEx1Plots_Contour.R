...
exgrid <- as.matrix(expand.grid(x1_grid,x2_grid))
mat_true_m1 <- matrix(m_1(exgrid),nrow=100)
mat_true_m2 <- matrix(m_2(exgrid),nrow=100)
...
inter_m1 <- interpp(x=x[,1],y=x[,2],z=output$m1,xo=exgrid[,1],yo=exgrid[,2],linear=FALSE,extrap=TRUE)$z
if (anyNA(inter_m1)){
  inter_m1_narm <- missForest(cbind(exgrid,inter_m1))$ximp
  inter_m1 <- inter_m1_narm[,3]
}

inter_m2 <- interpp(x=x[,1],y=x[,2],z=output$m2,xo=exgrid[,1],yo=exgrid[,2],linear=FALSE,extrap=TRUE)$z
if (anyNA(inter_m2)){
  inter_m2_narm <- missForest(cbind(exgrid,inter_m2))$ximp
  inter_m2 <- inter_m2_narm[,3]
}
...
plot_grid(~filled.contour(x1_grid,x2_grid,mat_true_m1,xlim=c(0,1),ylim=c(0,1),zlim=c(4,8),plot.title = title(main = "True m1",xlab = "x1", ylab = "x2")),
          ~filled.contour(x1_grid,x2_grid,mat_est1_m1,xlim=c(0,1),ylim=c(0,1),zlim=c(4,8),plot.title = title(main = "Estimated m1 (n=200)",xlab = "x1", ylab = "x2")),
          ~filled.contour(x1_grid,x2_grid,mat_est2_m1,xlim=c(0,1),ylim=c(0,1),zlim=c(4,8),plot.title = title(main = "Estimated m1 (n=400)",xlab = "x1", ylab = "x2")),
          ~filled.contour(x1_grid,x2_grid,mat_est3_m1,xlim=c(0,1),ylim=c(0,1),zlim=c(4,8),plot.title = title(main = "Estimated m1 (n=800)",xlab = "x1", ylab = "x2")))

plot_grid(~filled.contour(x1_grid,x2_grid,mat_true_m2,xlim=c(0,1),ylim=c(0,1),zlim=c(-2,2),plot.title = title(main = "True m2",xlab = "x1", ylab = "x2")),
          ~filled.contour(x1_grid,x2_grid,mat_est1_m2,xlim=c(0,1),ylim=c(0,1),zlim=c(-2,2),plot.title = title(main = "Estimated m2 (n=200)",xlab = "x1", ylab = "x2")),
          ~filled.contour(x1_grid,x2_grid,mat_est2_m2,xlim=c(0,1),ylim=c(0,1),zlim=c(-2,2),plot.title = title(main = "Estimated m2 (n=400)",xlab = "x1", ylab = "x2")),
          ~filled.contour(x1_grid,x2_grid,mat_est3_m2,xlim=c(0,1),ylim=c(0,1),zlim=c(-2,2),plot.title = title(main = "Estimated m2 (n=800)",xlab = "x1", ylab = "x2")))
