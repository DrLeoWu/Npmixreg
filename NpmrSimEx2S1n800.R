##########################################################################################################
##########################################################################################################
####### Simulation for nonparametric mixture of regression (Scenario 1, n=800, EX2 independent covariates)
##########################################################################################################
##########################################################################################################
...
m_1 <- function(x){
  return(10-3*sin(pi*x[,1]+pi*x[,1]))
}

m_2 <- function(x){
  return(4*cos(1*pi*x[,1]+3*pi*x[,2]))
}
